...
public class NewAccountFormValidationService {
    ...
    public boolean isNewAccountFormValid(NewAccountDto newAccountDto) {
        List<ValidationError> validationErrors = validateNewAccountForm(newAccountDto);
    ...
    private List<ValidationError> validateNewAccountForm(NewAccountDto newAccountDto) {
        List<List<ValidationError>> listOfErrors = new ArrayList<>();

        listOfErrors.add(checkNewAccountFormForNullFields(newAccountDto).getErrors());
    ...
    private Validator checkNewAccountFormForNullFields(NewAccountDto newAccountForm) {
